                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Lightbox</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Range Slider</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Sweet Alert</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Rating</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Forms</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Tables</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Charts</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Ecommerce</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Calendar</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Email</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Projects</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Tasks</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Contacts</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Light Sidebar</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Compact Sidebar</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Horizontal layout</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Maintenance</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Coming Soon</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">Timeline</a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('backend/javascript:void(0);') }}">FAQs</a>
                                        </li>
